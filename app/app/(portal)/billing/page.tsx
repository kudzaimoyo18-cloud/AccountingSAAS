            ...
            return (
              <article
                ...
                className={`flex flex-col rounded-2xl border p-6 shadow-card ${
                  isCurrent ? "border-evergreen bg-surface" : "border-line bg-surface"
                }`}
              >
                <div className="flex items-center justify-between">
                  <h2 className="font-display text-lg font-medium">{t.name}</h2>
                  {isCurrent && (
                    <span className="badge bg-evergreen/10 text-evergreen-deep">Your plan</span>
                  )}
                </div>
        ...
        <div className="card mt-8">
          ...
          <ol className="mt-4 space-y-3 text-sm text-ink-soft">
            <li className="flex gap-3">
              <span className="tnum font-display font-semibold text-evergreen-deep">1.</span>
              Tap the Ziina button for your plan — pay by card or Ziina app. Use your company
              name in the payment note.
            </li>
            <li className="flex gap-3">
              <span className="tnum font-display font-semibold text-evergreen-deep">2.</span>
              We confirm your payment and activate your compliance file — same business day.
            </li>
            <li className="flex gap-3">
              <span className="tnum font-display font-semibold text-evergreen-deep">3.</span>
